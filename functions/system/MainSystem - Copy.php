...
public function CallModule($module = '', $method = '', $parameters = ''){
	...
	$module_init_method = '__'.$module.'_INIT__';
...
protected static function SystemInstallModule($module){
	...
	trigger_error(self::ReturnLocalisationString(self::$lang['siya']['INSTALLER_FOUNCTION_NOT_FOUND'],array()));
	die;
	//trigger function not found error
	}
	}else{
	...
	$returnmessage .= $sqlvalue['modulefunction'] .trigger_error(self::ReturnLocalisationString(self::$lang['siya']['ACTION_ADDED_INTO_THE_DATABASE'],array())).'<br /><hr />';
	}else{
	$returnmessage .= $sqlvalue2.'<br />';
	...
	$returnmessage .= trigger_error(self::ReturnLocalisationString(self::$lang['siya']['MODULE_HAS_BEEN_SUCCESSFULLY_INSTALLED'],array($module))).'<br /><hr />';
	}else{
	$returnmessage .= $sql2.'<br />';
...
protected static function SystemInstallBlock($block){
	...
	require_once(PROJ_MODULES_DIR._S.$block._S.$block.'.php');
	...
	if($result2 = $sqlObj->FireSQL($sql2)){
	$returnmessage .= $sql2.'<br />';
	$returnmessage .= trigger_error(self::ReturnLocalisationString(self::$lang['siya']['BLOCK_HAS_BEEN_SUCCESSFULLY_INSTALLED'],array($block))).'<br /><hr />';
	}else{
	$returnmessage .= $sql2.'<br />';
...
protected static function SystemUnInstallModule($module){
	...
	$returnmessage .= trigger_error(self::ReturnLocalisationString(self::$lang['siya']['ACTIONS_ENTRIES_HAS_BEEN_SUCCESSFULLY_UNINSTALLED'],array($module))).'<br /><hr />';
	...
	if($result2 = $sqlObj->FireSQL($sql2)){
	$returnmessage .= $sql.'<br />';
	$returnmessage .= trigger_error(self::ReturnLocalisationString(self::$lang['siya']['MODULE_ENTRIES_HAS_BEEN_SUCCESSFULLY_UPDATED'],array($module))).'<br /><hr />';
	}else{
	$returnmessage .= $sql.'<br />';
...
protected static function SystemUnInstallBlock($block){
	...
	if($result = $sqlObj->FireSQL($sql)){
	$returnmessage .= $sql.'<br />';
	$returnmessage .= trigger_error(self::ReturnLocalisationString(self::$lang['siya']['ACTIONS_ENTRIES_HAS_BEEN_SUCCESSFULLY_UNINSTALLED'],array($block))).'<br /><hr />';
	...
	if($result2 = $sqlObj->FireSQL($sql2)){
	$returnmessage .= $sql.'<br />';
	$returnmessage .= trigger_error(self::ReturnLocalisationString(self::$lang['siya']['BLOCK_HAS_BEEN_SUCCESSFULLY_UNINSTALLED'],array($block))).'<br /><hr />';
	}else{
	$returnmessage .= $sql.'<br />';
...
static function CheckModuleAccess(){
...
$module_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['THIS_MODULE_IS_NOT_ACTIVE'],array());
return $module_accessreturn_array;
}

if($resultset->isinstalled != '1'){
$module_accessreturn_array['noerror'] = 0;
$module_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['THIS_MODULE_IS_NOT_INSTALLED'],array());
return $module_accessreturn_array;
}

}else{
$module_accessreturn_array['noerror'] = 0;
$module_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['PLEASE_REINSTALL_THE_MODULE'],array());
return $module_accessreturn_array;
}
}else{
$module_accessreturn_array['noerror'] = 0;
...
static function CheckModuleActionAccess($template = ''){
...
$module_action_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['THIS_MODULE_ACTION_IS_NOT_ACTIVE'],array());
...
if(!in_array($userdetailsarray->usertypetag,$usertypeaccessarray)){
if(!in_array($userdetailsarray->usertypetag,$usertypeaccessoverridesarray)){

$module_action_accessreturn_array['noerror'] = 0;
$module_action_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['USER_TYPE_ACCESS_DENIED'],array());
...
$module_action_accessreturn_array['noerror'] = 0;
$module_action_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['TEMPLATE_ACCESS_DENIED'],array());
...
$module_action_accessreturn_array['noerror'] = 0;
$module_action_accessreturn_array['message'] = self::ReturnLocalisationString(self::$lang['siya']['PLEASE_REINSTALL_THE_MODULE'],array());
...
$columns2 = array('id','actionname','otheruserstypeaccess');
$conditions2 = array();
...
if($resultset2->otheruserstypeaccess==''){
$otheruserstypeaccess = PROJ_DEFAULT_OTHERUSERS_PERMISSIONS;
}else{
$otheruserstypeaccess = $resultset2->otheruserstypeaccess;
}
...
//print_r($otheruserstypeaccessarray2);

if($otheruserstypeaccessarray2[0]==$owneruserdetailsarray->usertypetag){
$usertypeaccessvalue = $otheruserstypeaccessarray2[1];

if(strstr($otheruserstypeaccessarray2[1], ',')){
$otheruserstypeaccessarray3 = explode(',',$otheruserstypeaccessarray2[1]);
}else{
$otheruserstypeaccessarray3[] = $otheruserstypeaccessarray2[1];
}

if(in_array('self',$otheruserstypeaccessarray3) && $loggedinuserdetailsarray->id != $resultset->ownerid){

echo $owneruserdetailsarray->usertypetag.' SELF access for this Action so it is not possible for '.$loggedinuserdetailsarray->usertypetag.' to access this';

}

if(!in_array('self',$otheruserstypeaccessarray3)){
if(in_array($loggedinuserdetailsarray->usertypetag,$otheruserstypeaccessarray3)){
echo $loggedinuserdetailsarray->usertypetag.' can access this Action';
}else{
echo $loggedinuserdetailsarray->usertypetag.' CANNOT access this Action';
}
}

}else{
//echo 'No Permissions has been defined for this type of User';die;
}
}
...
public static function CreateNoofRecordsDropDown(){
...
if(self::IsAdminLogged() && PROJ_OVERRIDE_ADMIN_TEMPLATE == 1 && $PROJ_NON_OVERRIDE_CONDITION==false){
