...
if($module =='cms' && $action =='getContent' && _PARAMETERS == ''){
$parameters = array('1');
}else{
$parameters = explode(',', _PARAMETERS);
}

MainSystem::CreateFronendSession();
...
define('_TEMPLATE_THEMES_DIR',PROJ_TEMPLATES_WWW_DIR._WS.PROJ_DEFAULT_TEMPLATE_DIR._WS.PROJ_TEMPLATE_THEMES_DIR);
...
define('_FORM_CLASS_NOT_REQUIRED','class="'.PROJ_AJAX_HTML_POST_CLASS_NORMAL.'"'); 
}else{
define('_FORM_CLASS','class="required"');
define('_FORM_CLASS_NOT_REQUIRED','class=""'); 
}

define('_FORM_FINAL',_FORM_REQUIRED.' '._FORM_CLASS); 
...
$resultset = $MainSystemObj->CallModule($module,$action,$parameters); // ClassName , Method Name, Parameters in Array
	...
	if(isset($resultset['main_content2_placeholder']) && $resultset['main_content2_placeholder'] != ''){ 
...
$_SESSION['controllers']['HIDE_TEMPLATE_HEADER_PART'] = 1;
}else if(isset($_GET['HIDE_TEMPLATE_HEADER_PART']) && $_GET['HIDE_TEMPLATE_HEADER_PART']==0){
$_SESSION['controllers']['HIDE_TEMPLATE_HEADER_PART'] = 0;
}else if(!isset($_SESSION['controllers']['HIDE_TEMPLATE_HEADER_PART'])){
$_SESSION['controllers']['HIDE_TEMPLATE_HEADER_PART'] = 0;
}

if(isset($_GET['HIDE_TEMPLATE_FOOTER_PART']) && $_GET['HIDE_TEMPLATE_FOOTER_PART']==1){
$_SESSION['controllers']['HIDE_TEMPLATE_FOOTER_PART'] = 1;
}else if(isset($_GET['HIDE_TEMPLATE_FOOTER_PART']) && $_GET['HIDE_TEMPLATE_FOOTER_PART']==0){
$_SESSION['controllers']['HIDE_TEMPLATE_FOOTER_PART'] = 0;
}else if(!isset($_SESSION['controllers']['HIDE_TEMPLATE_FOOTER_PART'])){
$_SESSION['controllers']['HIDE_TEMPLATE_FOOTER_PART'] = 0;
}

if(isset($_GET['HIDE_TEMPLATE_LEFT_PART']) && $_GET['HIDE_TEMPLATE_LEFT_PART']==1){
$_SESSION['controllers']['HIDE_TEMPLATE_LEFT_PART'] = 1;
}else if(isset($_GET['HIDE_TEMPLATE_LEFT_PART']) && $_GET['HIDE_TEMPLATE_LEFT_PART']==0){
$_SESSION['controllers']['HIDE_TEMPLATE_LEFT_PART'] = 0;
}else if(!isset($_SESSION['controllers']['HIDE_TEMPLATE_LEFT_PART'])){
$_SESSION['controllers']['HIDE_TEMPLATE_LEFT_PART'] = 0;
}

if(isset($_GET['HIDE_TEMPLATE_RIGHT_PART']) && $_GET['HIDE_TEMPLATE_RIGHT_PART']==1){
$_SESSION['controllers']['HIDE_TEMPLATE_RIGHT_PART'] = 1;
}else if(isset($_GET['HIDE_TEMPLATE_RIGHT_PART']) && $_GET['HIDE_TEMPLATE_RIGHT_PART']==0){
$_SESSION['controllers']['HIDE_TEMPLATE_RIGHT_PART'] = 0;
}else if(!isset($_SESSION['controllers']['HIDE_TEMPLATE_RIGHT_PART'])){
$_SESSION['controllers']['HIDE_TEMPLATE_RIGHT_PART'] = 0;
}

if(isset($_GET['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART']) && $_GET['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART']==1){
$_SESSION['controllers']['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART'] = 1;
}else if(isset($_GET['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART']) && $_GET['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART']==0){
$_SESSION['controllers']['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART'] = 0;
}else if(!isset($_SESSION['controllers']['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART'])){
$_SESSION['controllers']['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART'] = 0;
}

if(isset($_GET['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART']) && $_GET['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART']==1){
$_SESSION['controllers']['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART'] = 1;
}else if(isset($_GET['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART']) && $_GET['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART']==0){
$_SESSION['controllers']['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART'] = 0;
}else if(!isset($_SESSION['controllers']['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART'])){
$_SESSION['controllers']['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART'] = 0;
}


if($_SESSION['controllers']['HIDE_TEMPLATE_HEADER_PART'] == 1){
$HIDE_TEMPLATE_HEADER_PART = 1;
}else{
$HIDE_TEMPLATE_HEADER_PART = 0;
}

if($_SESSION['controllers']['HIDE_TEMPLATE_FOOTER_PART'] == 1){
$HIDE_TEMPLATE_FOOTER_PART = 1;
}else{
$HIDE_TEMPLATE_FOOTER_PART = 0;
}

if($_SESSION['controllers']['HIDE_TEMPLATE_LEFT_PART'] == 1){
$HIDE_TEMPLATE_LEFT_PART = 1;
}else{
$HIDE_TEMPLATE_LEFT_PART = 0;
}

if($_SESSION['controllers']['HIDE_TEMPLATE_RIGHT_PART'] == 1){
$HIDE_TEMPLATE_RIGHT_PART = 1;
}else{
$HIDE_TEMPLATE_RIGHT_PART = 0;
}

if($_SESSION['controllers']['HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART'] == 1){
$HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART = 1;
}else{
$HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART = 0;
}

if($_SESSION['controllers']['HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART'] == 1){
$HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART = 1;
}else{
$HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART = 0;
}
...
$_SESSION['controllers']['SELECTEDTHEME'] = $_GET['SELECTEDTHEME'];
}else if(isset($_GET['SELECTEDTHEME']) && $_GET['SELECTEDTHEME']==''){
$_SESSION['controllers']['SELECTEDTHEME'] = '';
...
$middle_div_2_columns_class = 'grid_7';
}
...
if($secondcolumntrue==1){
$middle_div_2_columns_class = 'grid_5';
}
...
if($secondcolumntrue==1){
$middle_div_2_columns_class = 'grid_3';
}
...
if($secondcolumntrue==1){
$middle_div_2_columns_class = 'grid_4';
}
...
if($HIDE_TEMPLATE_LEFT_PART==0){
$left_blocks_placeholder = MainSystem::CallBlocks('LEFT','FRONTEND');
}

if($HIDE_TEMPLATE_RIGHT_PART==0){
$right_blocks_placeholder = MainSystem::CallBlocks('RIGHT','FRONTEND');
}

if($HIDE_TEMPLATE_HEADER_PART==0){
$header_blocks_placeholder = MainSystem::CallBlocks('HEADER','FRONTEND');
}

if($HIDE_TEMPLATE_FOOTER_PART==0){
$footer_blocks_placeholder = MainSystem::CallBlocks('FOOTER','FRONTEND');
}

if($HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART==0){
$beforemiddlecontent_blocks_placeholder = MainSystem::CallBlocks('BEFOREMIDDLECONTENT','FRONTEND');
}

if($HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART==0){
$aftermiddlecontent_blocks_placeholder = MainSystem::CallBlocks('AFTERMIDDLECONTENT','FRONTEND');
}
