...
if($module == 'admin' && ($action == 'setupLogin' || $action == 'login' || $action == 'loginCheck') && empty($parameters)){
...
if(!MainSystem::IsAdminLogged() && $module != 'admin' && ($action != 'setupLogin' || $action != 'login' || $action != 'loginCheck') && empty($parameters)){
...
if($module == 'admin' && ($action == 'setupLogin' || $action == 'login' || $action == 'loginCheck') && empty($parameters)){
$module_action_accessreturn_array = MainSystem::CheckModuleActionAccess('admin',$module,$action);
}else{
...
$left_blocks_placeholder = MainSystem::CallBlocks('LEFT','BACKEND');
}

if($HIDE_TEMPLATE_RIGHT_PART==0){
$right_blocks_placeholder = MainSystem::CallBlocks('RIGHT','BACKEND');
}

if($HIDE_TEMPLATE_HEADER_PART==0){
$header_blocks_placeholder = MainSystem::CallBlocks('HEADER','BACKEND');
}

if($HIDE_TEMPLATE_FOOTER_PART==0){
$footer_blocks_placeholder = MainSystem::CallBlocks('FOOTER','BACKEND');
}

if($HIDE_TEMPLATE_BEFOREMIDDLECONTENT_PART==0){
$beforemiddlecontent_blocks_placeholder = MainSystem::CallBlocks('BEFOREMIDDLECONTENT','BACKEND');
}

if($HIDE_TEMPLATE_AFTERMIDDLECONTENT_PART==0){
$aftermiddlecontent_blocks_placeholder = MainSystem::CallBlocks('AFTERMIDDLECONTENT','BACKEND');
}
