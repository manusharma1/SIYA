...
<h3>Users Detail</h3>
	...
	<p><a href="#" OnClick="JavaScript:window.open ('<?php echo MainSystem::URLCreator('chat/showChatWindow/'.$id_placeholder.'/');?>','Chat Window','menubar=1,resizable=1,width=1024,height=750');"><?php echo $fname_placeholder.' '.$mname_placeholder.' '.$lname_placeholder.' ('.$entitytypetag_placeholder.' '.$isonline_placeholder.')'; ?></a></p>
