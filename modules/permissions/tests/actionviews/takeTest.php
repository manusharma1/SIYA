<?php
	...
	$_SESSION['message'] = self::$lang['siya']['tests']['TEST_ATTEMPTES_SAVED'];
	...
	$_SESSION['message'] = self::$lang['siya']['tests']['TEST_ATTEMPTES_CANNOT_BE_SAVED'];
	...
	$actionviewresult = MainSystem::CallOtherActionView(__CLASS__,'takeTest'); // REVIEW ABOUT THE SECURITY HERE//
	$functionreturnarray['title_placeholder'] = self::$lang['siya']['tests']['ERROR_TEST_ATTEMPTES_CANNOT_BE_SAVED'];
...
<fieldset>
	...
	<legend>Questions Details</legend>
	...
	?>
	<label for="true"><input type="radio" name="<?php echo $id_placeholder; ?>" value="true" class="<?php echo PROJ_AJAX_HTML_POST_CLASS_NORMAL; ?>" /> True<br />
	<label for="false"><input type="radio" name="<?php echo $id_placeholder; ?>" value="false">False </label>
	<?php
	}
