...
?>
	...
	?>
		...
		<li>
		<p>
		<label class="label_check" for="checkbox<?php echo $i; ?>"><input name="questionid[]" id="checkbox<?php echo $i; ?>" value="<?php echo $id_placeholder; ?>" type="checkbox" class="<?php echo PROJ_AJAX_HTML_POST_CLASS_NORMAL;?> required" />
		</label>
