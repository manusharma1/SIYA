...
<?php
if(PROJ_RUN_AJAX==1){
$formaction = MainSystem::URLCreator('importexport/saveStudentFromExcel/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
}else{
$formaction = MainSystem::URLCreator('importexport/saveStudentFromExcel/');
}
?>
