...
<?php
if(PROJ_RUN_AJAX==1){
$formaction = MainSystem::URLCreator('importexport/saveParentFromExcel/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
}else{
$formaction = MainSystem::URLCreator('importexport/saveParentFromExcel/');
}
?>
...
<fieldset>
	...
	<ol>
		...
		<li>
		<label for="select">Select Z </label><select name="Z" id="Z" class="<?php echo PROJ_AJAX_HTML_POST_CLASS_NORMAL;?> required" />
		<option value="">------</option>
		<option value="usertypetag" >User Type Tag</option>
		<option value="entitytypetag">Entity Type Tag</option>
		<option value="username">User Name</option>
