<?php
	...
	$conditions['=']['id'] = $id;
	$sqlObj = new MainSQL();
	$sqlpagecontents = $sqlObj->SQLCreator('S', 'assignments', $columns, $conditions, '', '', '');
	...
	$name_placeholder = $sqlObj->getCleanData($resultsetpagecontents->name);
	}
	}else{
	...
	$delete_url  = 'assignments/deleteAssignmentConfirmed/'.$id.','.$topicid.'/';

?>

<table width="100%" class="tableclass"  align="center">
<tr class="trclass" >
<td width="100%" class="tdclass"  align="center"><br /><b>Are you sure you want to delete this assignment : "<?php echo $name_placeholder; ?>" ? <br /> You cannot undo this action once confirmed. </b> <br /><br /> <input type="button" onclick="JavaScript:document.location.href='<?php echo MainSystem::URLCreator($delete_url);?>';" value="Yes delete this assignment"> <input type="button" onclick="JavaScript:document.location.href='<?php echo MainSystem::URLCreator('stage/showTopic/');?>';" value="Cancel"> <br /><br /></td>
</tr>
</table>