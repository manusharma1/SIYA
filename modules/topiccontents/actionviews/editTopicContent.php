...
<?php
if(PROJ_RUN_AJAX==1){
$formaction = MainSystem::URLCreator('topiccontents/saveTopicContent/'.$id.'/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
}else{
$formaction = MainSystem::URLCreator('topiccontents/saveTopicContent/'.$id.'/');
}
...
<fieldset>
	...
	<ol><li>
		...
		<li>
		<label for="chosenfile">Choose File to Upload</label><br />
