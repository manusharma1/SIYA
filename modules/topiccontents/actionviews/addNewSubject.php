...
<fieldset>
	...
	<ol>
		<li>
		<label for="groupid">Group <?php echo $groupid_placeholder; ?> </label>
	    </li>

		<li>
		<label for="batchid">Batch <?php echo $batchid_placeholder; ?> </label>
	    </li>

		<li>
		<label for="subjectcode"><?php echo $lang['siya']['topiccontents']['SUBJECT_CODE'];?></label>
		<input id="subjectcode" name="subjectcode" type="text" placeholder="<?php echo $lang['siya']['topiccontents']['SUBJECT_CODE'];?>" value="<?php echo $subjectcode_placeholder; ?>" <?php echo _FORM_FINAL; ?> />
		</li>

		<li>
		<label for="name"><?php echo $lang['siya']['topiccontents']['TITLE'];?></label>
		<input id="name" name="name" type="text" placeholder="<?php echo $lang['siya']['topiccontents']['TITLE'];?>" required="" autofocus="" value="<?php echo $name_placeholder; ?>" class="<?php echo PROJ_AJAX_HTML_POST_CLASS_NORMAL;?> required">
		</li>

		<li>
		<label for="description"><?php echo $lang['siya']['topiccontents']['DESCRIPTION'];?></label>
		<textarea id="description" name="description" type="text" placeholder="<?php echo $lang['siya']['topiccontents']['DESCRIPTION'];?>" rows="5" required="" autofocus="" class="<?php echo PROJ_AJAX_HTML_POST_CLASS_NORMAL;?> required"><?php echo $description_placeholder; ?></textarea>
		</li>
