...
// More Logics to come - for filtering //
	...
	*/
	...
	if(PROJ_RUN_AJAX==1){
	$formaction = MainSystem::URLCreator('groups/saveOtherUsersToGroup/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
	}else{
	$formaction = MainSystem::URLCreator('groups/saveOtherUsersToGroup/');
	}
