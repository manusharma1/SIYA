...
$photofile_placeholder = (isset($_POST['chosenfile']))?$_POST['chosenfile']:'';

$registrationno_placeholder=(isset($_POST['rollno']))?$_POST['rollno']:'';
...
<?php
if(PROJ_RUN_AJAX==1){
$formaction = MainSystem::URLCreator('users/saveRegistrationStudentFront/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
}else{
$formaction = MainSystem::URLCreator('users/saveRegistrationStudentFront/');
}
?>
...
<fieldset>
	...
	<ol>
		<li>
		<label for="usertypetag">User Type Tag </label><br /><?php echo $usertypetag_placeholder; ?>
		</li>
		<li>
		<label for="entitytypetag">Entity Type Tag </label><br /><?php echo $entitytypetag_placeholder; ?>
		</li>
		...
		<li>
		<label for="registrationno"><?php echo $lang['siya']['users']['REGISTRATION_NO']; ?></label><br />
		<input id="registrationno" name="registrationno" type="text" placeholder="<?php echo $lang['siya']['users']['REGISTRATION_NO']; ?>" value="<?php echo $registrationno_placeholder; ?>" <?php echo _FORM_CLASS_NOT_REQUIRED; ?> />
		</li>

		<li>
		<label for="doa"><?php echo $lang['siya']['users']['DATE_OF_ADDMISSION']; ?></label><br />
		<input id="doa" name="doa" type="text" placeholder="<?php echo $lang['siya']['users']['DATE_OF_ADDMISSION']; ?>" value="<?php echo $doa_placeholder; ?>" <?php echo _FORM_CLASS_NOT_REQUIRED; ?> />
		</li>
		
		<li>
		<label for="emergencycontactname"><?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NAME']; ?></label><br /><br />
		<input id="emergencycontactname" name="emergencycontactname" type="text" placeholder="<?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NAME']; ?>" value="<?php echo $emergencycontactname_placeholder; ?>" <?php echo _FORM_CLASS_NOT_REQUIRED; ?> />
		</li>
	
		<li>
		<label for="emergencycontactnumber"><?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NUMBER']; ?></label><br /><br />
		<input id="emergencycontactnumber" name="emergencycontactnumber" type="text" placeholder="<?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NUMBER']; ?>" value="<?php echo $emergencycontactnumber_placeholder; ?>" <?php echo _FORM_CLASS_NOT_REQUIRED; ?> />
		</li>
		
		
		<li>
		<label for="chosenfile"><?php echo $lang['siya']['users']['UPLOAD_PHOTO_FILE']; ?></label><br />
		<input id="chosenfile" name="chosenfile" type="file" placeholder="<?php echo $lang['siya']['users']['UPLOAD_PHOTO_FILE']; ?>" value="<?php echo $photofile_placeholder; ?>" <?php echo _FORM_CLASS_NOT_REQUIRED; ?> />
		</li>
