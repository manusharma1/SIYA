...
$("#addstudentregform").validate();
});
</script>

<?php
if(PROJ_RUN_AJAX==1){
$formaction = MainSystem::URLCreator('users/saveStudentRegistration/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
}else{
$formaction = MainSystem::URLCreator('users/saveStudentRegistration/');
}
?>

<form id="addstudentregform" name="addstudentregform" method="post" action="<?php echo $formaction; ?>" enctype="multipart/form-data">

<fieldset>

	<legend>Add New Student Registration</legend>
	...
	<ol>
		...
		<input id="registrationno" name="registrationno" type="text" placeholder="<?php echo $lang['siya']['users']['REGISTRATION_NO']; ?>" value="<?php echo $registrationno_placeholder; ?>" <?php echo _FORM_CLASS; ?> />
		</li>
		...
		<input id="emergencycontactname" name="emergencycontactname" type="text" placeholder="<?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NAME']; ?>" value="<?php echo $emergencycontactname_placeholder; ?>" <?php echo _FORM_CLASS; ?> />
		</li>
	
		<li>
		<label for="emergencycontactnumber"><?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NUMBER']; ?></label><br />
		<input id="emergencycontactnumber" name="emergencycontactnumber" type="text" placeholder="<?php echo $lang['siya']['users']['EMERGENCY_CONTACT_NUMBER']; ?>" value="<?php echo $emergencycontactnumber_placeholder; ?>" <?php echo _FORM_CLASS; ?> />
		</li>
		
		
		<li>
		<label for="chosenfile"><?php echo $lang['siya']['users']['UPLOAD_PHOTO_FILE']; ?></label>
		<input id="chosenfile" name="chosenfile" type="file" placeholder="<?php echo $lang['siya']['users']['UPLOAD_PHOTO_FILE']; ?>" value="<?php echo $photofile_placeholder; ?>" <?php echo _FORM_CLASS; ?> />
		</li>
