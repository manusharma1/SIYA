...
$id = _ACTION_VIEW_PARAMETER_ID;
	...
	MainSystem::CheckIDExists('users','id',$id,'users/manageStudents/');
...
$columns = array('u.id','u.usertypetag','u.entitytypetag','u.username','u.fname','u.mname','u.lname','u.gender','u.email','u.phone','u.addressline1','u.addressline2','u.city','u.state','u.country','u.nationality','u.dob','st.registrationno','st.doa','st.emergencycontactname','st.emergencycontactnumber');
...
$registrationno_placeholder =  $sqlObj->getCleanData($resultset->registrationno);
$doa_placeholder =  $sqlObj->getCleanData($resultset->doa);
...
$("#editstudentregistrationform").validate();
});
</script>

<?php
if(PROJ_RUN_AJAX==1){
$formaction = MainSystem::URLCreator('users/saveStudentRegistration/'.$id.'/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
}else{
$formaction = MainSystem::URLCreator('users/saveStudentRegistration/'.$id.'/');
}
?>
<form id="editstudentregistrationform" name="editstudentregistrationform" method="post" action="<?php echo $formaction; ?>" enctype="multipart/form-data">
...
<fieldset>
	...
	<ol>
		...
		<input id="registrationno" name="registrationno" type="text" placeholder="<?php echo $lang['siya']['users']['REGISTRATION_NO']; ?>" value="<?php echo $registrationno_placeholder; ?>" <?php echo _FORM_FINAL; ?> />
		</li>
