...
<h3 class="headingh3">Web Conferencing Detail</h3>
	...
	*/
	...
	'password' => $resultset->moderatorpw,					// REQUIRED - Must match either attendee or moderator pass for meeting.
	...
	if ($itsAllGood == true) {
	?>
	<p><a class="button orange large" href="<?php echo $bbbresult;?>">Click Here to Join</a></p>
	<?php
	}
