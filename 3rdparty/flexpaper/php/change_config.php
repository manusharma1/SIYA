										...
										<tr>
											...
											<td style="border:0px">
												<font style="font-size:13px">
													<INPUT TYPE=RADIO NAME="SPLITMODE" id="SPLITMODE1" VALUE="0" <?php if($configManager->getConfig('splitmode') == false || $configManager->getConfig('splitmode') == "") { ?>checked="true"<?php } ?> style="vertical-align: middle"> one file<BR>
													<INPUT TYPE=RADIO NAME="SPLITMODE" id="SPLITMODE2" VALUE="1" <?php if($configManager->getConfig('splitmode') == true) { ?>checked="true"<?php } ?> style="vertical-align: middle"> split mode<BR>
												</font>
											</td>
										</tr>
