...
?>
 ...
 <div class="boxstyle1">
		...
		<?php
		if(PROJ_RUN_AJAX==1){
		$formaction2 = MainSystem::URLCreator('remarks/addRemark/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
		}else{
		$formaction2 = MainSystem::URLCreator('remarks/addRemark/');
		}
		?>
			...
			$controlsarray['editblockcontent']['url'] = 'remarks/editRemarks/'.$id.'/';
			...
			$controlsarray['deleteblockcontent']['url'] = 'remarks/deleteRemarks/'.$id.'/';
			...
			$controlsarray['moveupblockcontent']['url'] = 'remarks/changeRemarkOrder/up,'.$blockid.'/';
			}
			...
			$controlsarray['movedownblockcontent']['url'] = 'remarks/changeRemarkOrder/down,'.$blockid.'/';
			}
			...
			<a href="<?php echo MainSystem::URLCreator($url); ?>"><?php echo $messagetitle; ?></a>
			...
			<h5>Incoming Remarks</h5>
			<?php
			
			$columns = array('id','messagetitle','message');
			$sqlObj = new MainSQL();
			$conditions = array();
			$conditions['=']['remarksfor'] = $userid;
			...
			<p><a href="<?php echo MainSystem::URLCreator($url); ?>"><?php echo $messagetitle; ?></a>
