...
?>
 ...
 <div class="boxstyle1">
		...
		<?php
		if(PROJ_RUN_AJAX==1){
		$formaction2 = MainSystem::URLCreator('blogs/addNewBlog/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
		}else{
		$formaction2 = MainSystem::URLCreator('blogs/addNewBlog/');
		}
		?>
		...
		<form id="addform2" name="addform2" method="post" action="<?php echo $formaction2; ?>">
			...
			$sql = $sqlObj->SQLCreator('S', 'blogs', $columns, $conditions, '', '0', '4');
			if($result = $sqlObj->FireSQL($sql)){
			...
			<a href="<?php echo MainSystem::URLCreator($url); ?>"><?php echo $title_placeholder; ?></a>
