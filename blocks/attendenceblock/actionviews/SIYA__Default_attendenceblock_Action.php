...
?>
 ...
 <div class="boxstyle1">
        ...
        <div class="boxstyle3">
			...
			<form id="addform2" name="addform2" method="get" action="<?php echo MainSystem::URLCreator('attendence/showAttendence/'.$groupid.'/');?>">

			<fieldset>
			<button type="submit">Show Attendence</button>
			</fieldset>
