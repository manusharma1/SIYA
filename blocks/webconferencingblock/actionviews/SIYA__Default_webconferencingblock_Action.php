...
?>
 ...
 <div class="boxstyle1">
		...
		<?php
		if(PROJ_RUN_AJAX==1){
		$formaction3 = MainSystem::URLCreator('webconferencing/addWebConferencing/','ajax','post','',PROJ_AJAX_DEFAULT_HTML_ID_FOR_TEMPLATE,false);
		}else{
		$formaction3 = MainSystem::URLCreator('webconferencing/addWebConferencing/');
		}
		?>

		<?php
		$returnarrayblockaddaccess = MainSystem::CheckModuleActionAccess('admin','webconferencing','addWebConferencing');
		if($returnarrayblockaddaccess['noerror'] == 1){
		?>

		<form id="addwebconfrencingblock" name="addwebconfrencingblock" method="post" action="<?php echo $formaction3; ?>">
		...
		?>
			...
			$sqlObj = new MainSQL();
			$sql = $sqlObj->SQLCreator('S', 'webconferencing', $columns3, $conditions3, '', '', '');
			...
			$controlsarray['editblockcontent']['url'] = 'webconferencing/editWebConferencing/'.$id.'/';
			...
			$controlsarray['deleteblockcontent']['url'] = 'webconferencing/deleteWebConferencing/'.$id.'/';
			...
			$controlsarray['moveupblockcontent']['url'] = 'webconferencing/changeWebConferencingOrder/up,'.$blockid.'/';
			}
			...
			$controlsarray['movedownblockcontent']['url'] = 'webconferencing/changeWebConferencingOrder/down,'.$blockid.'/';
			}
			...
			<button type="submit">Add Conferencing</button>
