...
function SIYA__loginblock_INSTALLER__(){

$block_installer_info_array = array();
$block_installer_info_array['block']['info'] = array('description' => '');
$block_installer_info_array['action']['showLoginBlock'] = array('usertypeaccess'=>'', 'templateaccess'=>'', 'description' => '');
return $block_installer_info_array;
}

function SIYA__loginblock_INIT__(){
...
static function showLoginBlock($blocktitle = '')
{
