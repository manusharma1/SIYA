...
?>
                    <article class="grid_8 prefix_1">
                        <h2 class="spacing-bot">I would like to Help you by Donating to Your Campaign</h2>
                        <div id="contact_form">
                            <form id="contactform" name="contactform" method="post" action="<?php echo MainSystem::URLCreator('contactform/contactFormSubmit/'.$pageid.'/1/') ?>" onsubmit="return JSFunctionDonateContactForm(this);">
                                <fieldset>
                                    <div class="field">
                                    ...
                                    <div class="field">
										<input type="radio" name="donate" id="donate_1" value="50"> $50.00
										<input type="radio" name="donate" id="donate_2" value="100"> $100.00
										<input type="radio" name="donate" id="donate_3" value="otheramount"> Other Amount <br />

                                        <label class="error" for="message" id="message_error">*This field is required.</label>
                                    </div>

                                    <div class="field">
										<input type="text" name="donateamount" id="donateamount" value="Message:" class="text-input" title="Donation Amount" onFocus="if(this.value=='Message:'){this.value=''}" onBlur="if(this.value==''){this.value='Message:'}">
									</div>
                                    ...
                                    <div class="field">
                                       ...
                                       <input type="text" name="captchatext" id="captchatext" value="Enter Security Code Shown Above:" title="Security Image Text" class="text-input" onFocus="if(this.value=='Enter Security Code Shown Above:'){this.value=''}" onBlur="if(this.value==''){this.value='Enter Security Code Shown Above:'}" />
										...
										<input type="hidden" name="contactformid" id="contactformid" value="4" />
